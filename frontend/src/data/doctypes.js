...
export const SECTIONS = ['Selling', 'Buying', 'Inventory', 'Accounts']
...
export const LISTS = [
  ...
  { key: 'material-request', section: 'Buying', title: 'Material Requests', doctype: 'Material Request', icon: ClipboardList, orderBy: 'transaction_date desc',
    columns: [ { label: 'Request', field: 'name' }, { label: 'Type', field: 'material_request_type' }, { label: 'Date', field: 'transaction_date', type: 'date' }, { label: 'Status', field: 'status', type: 'status' } ],
  ...
  { key: 'stock-entry', section: 'Inventory', title: 'Stock Entries', doctype: 'Stock Entry', icon: Repeat, orderBy: 'posting_date desc',
    columns: [ { label: 'Entry', field: 'name' }, { label: 'Type', field: 'stock_entry_type' }, { label: 'Date', field: 'posting_date', type: 'date' } ],
  ...
  { key: 'stock-reconciliation', section: 'Inventory', title: 'Stock Reconciliations', doctype: 'Stock Reconciliation', icon: Scale, orderBy: 'posting_date desc',
    columns: [ { label: 'Reconciliation', field: 'name' }, { label: 'Purpose', field: 'purpose' }, { label: 'Date', field: 'posting_date', type: 'date' } ],
  ...
  { key: 'payment-entry', section: 'Accounts', title: 'Payment Entries', doctype: 'Payment Entry', icon: CreditCard, orderBy: 'posting_date desc', currencyField: 'paid_to_account_currency', special: 'payment',
    columns: [ { label: 'Payment', field: 'name' }, { label: 'Type', field: 'payment_type' }, { label: 'Party', field: 'party_name' }, { label: 'Date', field: 'posting_date', type: 'date' }, { label: 'Amount', field: 'paid_amount', type: 'currency' } ] },
  { key: 'journal-entry', section: 'Accounts', title: 'Journal Entries', doctype: 'Journal Entry', icon: BookOpen, orderBy: 'posting_date desc', currencyField: '',
    columns: [ { label: 'Entry', field: 'name' }, { label: 'Type', field: 'voucher_type' }, { label: 'Date', field: 'posting_date', type: 'date' }, { label: 'Debit', field: 'total_debit', type: 'currency' } ],
